...
<div class="my-12 p-8 bg-white rounded-[2.5rem] border border-blue-50 shadow-xl shadow-blue-900/5">
    <h4 class="text-center text-slate-900 font-black mb-8 tracking-tight">Havi adókedvezmény mértéke (2022-2026)</h4>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [44100, 46800, 55800, 58800, 60900, 63000, 66600, 76500, 82800, 89400, 96600, 100440, 120000, 139200, 160080, 174480, 193680], // Példa összegek
...
3. **Dátumozás:** A kedvezmény az orvosi igazoláson szereplő szakorvosi dokumentáció dátumától (gyakorlatilag a teszt napjától, de ez függ a háziorvostól) jár.
